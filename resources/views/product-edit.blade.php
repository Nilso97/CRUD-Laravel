...
<body>
    <div class="container">
        ...
        <form action="/editar-produto/{{ $product->id }}" method="POST">
            @csrf
            <div class="row ">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="form_product_price" type="text" name="price"
                                                        value="{{ $product->product_price }}" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="form_qt_stock" type="text" name="stock"
                                                        value="{{ $product->qt_stock }}" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="form_product_description" type="text"
